...
- [ ] **ユーザー**: 左右分割通信を確認する（無操作後に左Peripheralが操作不能となる回帰を確認）
- [x] **ユーザー**: ポインター移動、Auto Mouse、Scrollレイヤー、左右クリック、MB4／MB5を確認する
- [ ] **ユーザー**: Sleep復帰、USB、Bluetooth接続を確認する（左右間BLE修正後に再確認）
...
- [ ] **ユーザー**: 修正版の右Centralを書き込み、電池駆動で1分以上放置後も左キーが入力できることを確認する
